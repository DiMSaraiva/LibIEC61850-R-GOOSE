...
//        IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_RPi1_GGIO1_AnIn4_mag_f, an4);
        ...
        if (IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind1_stVal) != digitalRead(26)) {
            ...
            cout<<"Pin 12 changed!                                 | digitalRead:  "<<IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind1_stVal)<<endl;
        }
        else{
            cout<<"No changes pin 12, no changes on START!         | digitalRead:  " << digitalRead(26) <<endl;
        ...
        if (IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind2_stVal) != digitalRead(27)) {
            ...
            cout<<"Pin 16 changed!                                 | digitalRead:  "<<IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind2_stVal)<<endl;
        }
        else{
            cout<<"No changes pin 16, no changes on OVERVOLTAGE!   | digitalRead:  " << digitalRead(27) <<endl; 
            IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_RPi1_GGIO1_Ind2_stVal, !digitalRead(27));
        };
        ...
        if (IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind3_stVal) != digitalRead(28)) {
            ...
            cout<<"Pin 20 changed!                                 | digitalRead:  "<<IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind3_stVal)<<endl;
        }
        else{
            cout<<"No changes pin 20, no changes on LOCAL STOP!    | digitalRead:  " << digitalRead(28) <<endl;
        };
       ...
       //----------CENTRAL STOP----input
        if (IedServer_getBooleanAttributeValue(iedServer,IEDMODEL_RPi1_GGIO1_Ind4_stVal) != digitalRead(29)) {
            ...
            cout<<"No changes pin 21, no changes on CENTRAL STOP!  | digitalRead:  "  << digitalRead(29) <<endl;
        };
