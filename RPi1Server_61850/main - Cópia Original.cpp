...
//------------------------------------------GOOSE subscriber />
//__________________________________________________________________________________________________________________Zápis dat od klienta
static MmsDataAccessError
writeAccessHandler (DataAttribute* dataAttribute, MmsValue* value, ClientConnection connection, void* parameter)
{
    if (dataAttribute == IEDMODEL_RPi1_GGIO1_NamPlt_vendor) {
            if (dataAttribute == IEDMODEL_RPi1_GGIO1_NamPlt_vendor) {
        cout<<"Novy nazev zarizeni :"<<MmsValue_toString(value)<<endl; 
    ...
    if (dataAttribute == IEDMODEL_RPi1_GGIO1_AnIn11_mag_f) {
        ...
        cout<<"Nova hodnota AnIn11.f :"<<newValue<<endl;
        ...
        cout<<"Nova hodnota AnIn11.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn12.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn13.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn14.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn15.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn16.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn17.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
        ...
        int newValue = MmsValue_toInt32(value);
        cout<<"Nova hodnota AnIn18.i :"<<newValue<<endl;
        //printf("New value for OutVarSet_setMag_f = %f\n", newValue);
...
//-------------------------------------------------------------------------------------------------------------------//Zápis dat
//_____________________________________________________________________________________________________________________ Kontrol
...
//        IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_RPi1_GGIO1_AnIn4_mag_f, an4);
        ...
        //______________________________________________________________________________________________________//Zapis//
        //
